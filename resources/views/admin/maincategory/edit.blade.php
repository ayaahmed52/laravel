                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.MainCategory')}}"> الاقسام </a>
                                </li>
                    ...
                    <div class="row match-height">
                      ...
                      <div class="card-content collapse show">
                                ...
                                <form class="form" action="{{route('admin.MainCategory.update',$mainCategory->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img style="width: 300px" src="{{$mainCategory->photo}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                        ...
                        <ul class="nav nav-tabs nav-top-border no-hover-bg">
                            ...
                            <li class="nav-item">
                               <a class="nav-link active" id="base-tab11" data-toggle="tab" aria-controls="tab11"
                                  href="#tab11{{$index}}" aria-expanded="true">{{$translation -> translation_lang}}</a>
                            </li>
                                @endforeach
                            @endisset
                         </ul>
                        ...
                        <div class="tab-content px-1 pt-1">
                            @isset($mainCategory -> categories)
                                @foreach($mainCategory -> categories   as $index =>  $translation)
                                <div role="tabpanel" class="tab-pane active" id="tab11{{$index}}"
