                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.Vendors')}}"> الاقسام </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل المتجر {{$vendor -> name}} </h4>
                                ...
                                <form class="form" action="{{route('admin.Vendors.update',$vendor->id)}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img style="width: 300px" src="{{$vendor->logo}}">
                                                </div>
                                            </div>
                                                                    ...
                                                                    <optgroup label="من فضلك أختر القسم ">
                                                                        @if($categories && $categories -> count() > 0)
                                                                            @foreach($categories as $category)
                                                                                <option
                                                                                    value="{{$category -> id }}" @if($vendor -> category_id == $category -> id  )  selected @endif
